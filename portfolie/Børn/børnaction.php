...
if(isset($_POST["action"]))
{
 ...
 {
  $query = "SELECT * FROM boern ORDER BY id DESC";
 ...
 if($_POST["action"] == "insert")
 {
  ...
  $query = "INSERT INTO boern(name) VALUES ('$file')";
 ...
 {
  $file = addslashes(file_get_contents($_FILES["image"]["tmp_name"]));
  $query = "UPDATE boern SET name = '$file' WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
 ...
 {
  $query = "DELETE FROM boern WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
