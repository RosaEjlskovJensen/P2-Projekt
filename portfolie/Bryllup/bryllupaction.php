...
if(isset($_POST["action"]))
{
 ...
 {
  $query = "SELECT * FROM bryllup ORDER BY id DESC";
 ...
 if($_POST["action"] == "insert")
 {
  ...
  $query = "INSERT INTO bryllup(name) VALUES ('$file')";
 ...
 {
  $file = addslashes(file_get_contents($_FILES["image"]["tmp_name"]));
  $query = "UPDATE bryllup SET name = '$file' WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
 ...
 {
  $query = "DELETE FROM bryllup WHERE id = '".$_POST["image_id"]."'";
  if(mysqli_query($connect, $query))
  {
