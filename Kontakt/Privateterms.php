...
<head>
	<meta charset="utf-8">
	<title>Amalie Sandgaard | Photography | Privatlivspolitik</title>
  <!-- ajax/jquery -->
  	...
  	<div class="container">
  		<div class="row">
  			<div class="six columns padding1side">
  				...
  				<p class="faqtext"> Vi gemmer almindelige personoplysninger om dig, som alle er afgivet til os af dig. Eksempler på data, som du aktivt kan have afgivet er:<br></br>
•	Navn, adresse, telefonnummer, e-mailadresse og cvr. nr.<br><br>
•	Oplysninger du deler med os via de sociale medier, herunder LinkedIn, Instagram og Facebook<br><br>
•	Særligt personfølsomme oplysninger som deles ved sessions
	
  				</p></center>	
  			</div>
  			<div class="six columns padding1side">
  				<center><h6>Anvendelse og opbevaring af indsamlede data</h6>
  				<p class="faqtext">De indsamlede data anvendes med det formål at føre journal, for at kunne yde den bedst mulige behandling, samt informere og komme i kontakt med kunder.
  				</p></center>
  			</div>
  		</div>
  	</div>
  	...
  	<div class="container">
  		<div class="row">
  			<div class="six columns padding1side">
  				...
  				<p class="faqtext">•	Informationer opbevares på computerens egen harddisk, samt en ekstern harddisk<br><br>
