...
<title>test</title>
    ...
    <body>
		...
		<div class="six columns">	
			<div class="">
				<h2> Vælg Infoside <h2>
				<a href="Portfolieinfoupdate.php?id=0" class="btn3 btn-primary u-full-width">BABY</a>
				<a href="Portfolieinfoupdate.php?id=1" class="btn3 btn-primary u-full-width">BRYLLUP</a>
				<a href="Portfolieinfoupdate.php?id=2" class="btn3 btn-primary u-full-width">BØRN</a>
