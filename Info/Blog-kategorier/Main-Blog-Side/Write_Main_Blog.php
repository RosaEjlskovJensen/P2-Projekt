...
<body>
	<div class="row">
		<div class="six columns offset-by-three column">
			<form name="Blog_Form" class="u-full-width" autocomplete="on" method="post" action="process_input_Main_Blog.php">
...
<form method="post" action=>
	...
	<a href="EditKategoritemplate_Main.php" class="btn3 btn-warning u-pull-left">TILBAGE</a>
