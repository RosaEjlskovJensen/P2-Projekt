				...
				<div class="review-block">
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="review-block-name">Martin Spliid</div>
							<div class="review-block-date"><br/>For 3 måneder siden</div>
						</div>
						<div class="col-sm-9">
							...
							<div class="review-block-title">God oplevelse</div>
							<div class="review-block-description">Fantastisk pige, fantastisk service, fantastiske billeder.
jeg er fuldt ud tilfreds!</div>
						</div>
					</div>
					<hr/>
					<div class="row">
						<div class="col-sm-3">
							<img src="http://dummyimage.com/60x60/666/ffffff&text=No+Image" class="img-rounded">
							<div class="review-block-name">Rikke Rusbjerg</div>
							<div class="review-block-date"><br/>for 3 måneder siden</div>
						</div>
						<div class="col-sm-9">
							<div class="review-block-rate">
							...
							<div class="review-block-title">Fantastisk service</div>
							<div class="review-block-description">Meget nærværende pige, fantastisk service, og de bedste billeder. Jeg kan ikke finde en bedre fotograf, og jeg ønsker ingen anden fotograf.</div>
						</div>
					</div>
					<hr/>
					<div class="row">
						<div class="col-sm-3">
							<img src="http://dummyimage.com/60x60/666/ffffff&text=No+Image" class="img-rounded">
							<div class="review-block-name">poul poulsen</div>
							<div class="review-block-date"><br/>for 3 måneder siden</div>
						</div>
						<div class="col-sm-9">
							<div class="review-block-rate">
							...
							<div class="review-block-title">Kvalitet</div>
							<div class="review-block-description">Pris og kvalitet hænger ofte sammen, og hos Amalie får man virkelig meget for pengene!
jeg kommer helt sikkert tilbage!</div>
						</div>
					</div>
                    <hr/>
                    <div class="row">
						<div class="col-sm-3">
							<img src="http://dummyimage.com/60x60/666/ffffff&text=No+Image" class="img-rounded">
							<div class="review-block-name">Inge Sørensen</div>
							<div class="review-block-date"><br/>for 3 måneder siden</div>
						</div>
						<div class="col-sm-9">
							<div class="review-block-rate">
							...
							<div class="review-block-title">hos amalie</div>
							<div class="review-block-description">God og personlig betjening - god kontakt til vores guldklumper.</div>
						</div>
					</div>
				</div>
			</div>
      ...
      <center>
      <p>Hvis du ønsker at se flere anmeldeser, eller skrive din egen, brug linket <a href="https://www.google.com/search?client=safari&rls=en&q=amaliesandgaardphotography+reviews&ie=UTF-8&oe=UTF-8#lrd=0x464933a662f306d5:0x63fee768645596b7,1,,," style="color: black;">HER</a></p>
